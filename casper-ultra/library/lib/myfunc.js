...
exports.getTime = (format, date) => {
        if (date) {
                ...
                return moment.tz(global.botTimezone || 'Africa/Nairobi').locale('en').format(format)
        }
}
...
exports.tanggal = (numer) => {
        myMonths = ["January","February","March","April","May","June","July","August","September","October","November","December"];
                                ...
                                const time = moment.tz(global.botTimezone || 'Africa/Nairobi').format('DD/MM HH:mm:ss')
                                let d = new Date
                                let locale = 'en'
