    ...
    operate: async (context) => {
        ...
        async function xyy(prompt) {
            const response = await axios({
                method: "POST", url: "https://chateverywhere.app/api/chat",
                headers: {
                    ...
                    Origin: "https://chateverywhere.app", Referer: "https://chateverywhere.app/id",
                ...
                data: {
                    ...
                    messages: [
                        ...
                        { pluginId: null, content: `${global.botname} is a programmer from South Sumatra, Indonesia. He develops all applications.`, role: "assistant" }
                    ]
                }
            })
